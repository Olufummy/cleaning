(() => {
  ...
  quoteForm.addEventListener('submit', (event) => {
    ...
    const phone = document.querySelector('#quote-phone').value.trim() || 'Not provided';
    ...
    const details = document.querySelector('#quote-details').value.trim() || 'No additional details';
